...
save_results_path = '/ghome/zhuyr/Results/SBU/'
...
def test():
    ...
    net.load_state_dict(torch.load('/ghome/zhuyr/ACM MM22  Shadow Detection/CKPT_Shadow_Detection/SBU.PTH'))
    net.eval()
    images_list = glob.glob('/ghome/zhuyr/ACM MM22  Shadow Detection/SBU/shadow_imgs/*.*')
...
if __name__ == '__main__':
    ...
    gt_root = '/ghome/zhuyr/ACM MM22  Shadow Detection/SBU/mask'
